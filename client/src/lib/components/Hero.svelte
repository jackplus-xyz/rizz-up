...
<div class="flex flex-col items-center justify-center space-y-8 py-8 md:py-32">
	...
	>
		Unlock Your Personal Color Palette with <i class="mt-4 text-5xl md:text-8xl">Rizz Up</i>
	</h1>
	<p class="text-md mx-auto px-8 text-center font-serif md:px-4 md:text-2xl">
		Discover the perfect colors that complement your skin tone and style. And, finally find harmony
		in your wardrobe.
	</p>
	<div
